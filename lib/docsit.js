...
class Docsit {
  ...
  getAttachment(cid) {
    return (0, _documents.getAttachment)(this.ipfsClient, cid);
  }

  issueDocument(body, data, attachments) {
    return (0, _documents.issueDocument)(this.contract, this.ipfsClient, body, data, attachments);
  }
...
//# sourceMappingURL=docsit.js.map