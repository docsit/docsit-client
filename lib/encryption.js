...
exports.decryptMultiple = exports.encryptMultiple = exports.generateKey = exports.bufferToHexString = exports.hexStringToBuffer = exports.utf8StringToArray = void 0;
...
const decryptMultiple = async (encryptedArray, hexMagic, password) => {
  ...
  const decryptedArray = await Promise.all(encryptedArray.map(async encryptedText => {
    const decryptedBuffer = await window.crypto.subtle.decrypt({
      name: 'AES-CBC',
      iv: magic
    }, cryptoKey, utf8StringToArray(encryptedText));
